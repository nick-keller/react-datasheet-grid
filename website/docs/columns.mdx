...
This means that columns are very simple in their behavior, but in a real world application you might want rows to be complex objects, we will see in the next section how to do so.
