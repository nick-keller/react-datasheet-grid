...
custom inputs,
icons... View [default implementation](https://github.com/nick-keller/react-datasheet-grid/blob/master/src/components/AddRows.tsx)
to start implementing your own from a solid base.

Passing `false` will hide the component.

### contextMenuComponent
Used to customize the context menu when right clicking. View [default implementation](https://github.com/nick-keller/react-datasheet-grid/blob/master/src/components/ContextMenu.tsx)
to start implementing your own from a solid base..
