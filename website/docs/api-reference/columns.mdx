...
key by calling [stopEditing](#cell-component).
...
outside of the grid itself). This means that you have to handle the click event and call [stopEditing](#cell-component)
