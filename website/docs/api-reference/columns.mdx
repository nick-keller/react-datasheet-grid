...
::: info
#### Fixed sized columns
To make a fixed width column of 100 pixels that does not shrink or grow:
```tsx
const column = { basis: 100, grow: 0, shrink: 0 }
```
:::
...
```tsx
const columns = [
  {}, // 👈 This column will grow and shrink normally
  { shrink: 3 }, // 👈 This column will shrink 3 times faster than the others
  { grow: 2 }, // 👈 This column will grow 2 times faster than the others
]
```
:::
